...
const AdminDashboard = () => {
    ...
    if (loading) return <div className="text-center py-400 text-xl font-semibold">Loading admin panel...</div>;

    return (
        <div className="max-w-7xl py-3 mx-auto">
            <div className="bg-gray-900/95 text-white rounded-2xl p-20 sm:p-8 mb-8 shadow-lg flex flex-col md:flex-row justify-between items-center gap-6 text-center md:text-left">
                <div>
